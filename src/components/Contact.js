       ...
       <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-no-wrap flex-wrap flex-col">
        ...
        <div class=" mx-auto">
          ...
          <div className="flex flex-wrap lg:flex-nowrap  items-center justify-between w-full ">
            <div className="md:w-8/12 bg-white mb-8 md:mb-0 md:mr-8 py-8 px-6 shadow-lg rounded-md md:h-96">
              <ContactForm />
            </div>
            <div className="md:w-4/12  bg-white py-8 md:h-96 px-6 shadow-lg rounded-md flex flex-wrap items-start">
              <div  className="">
